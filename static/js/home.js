$(function() {
  $(".typed").typed({
    strings: [
      ...
      "><span class='caret'>$</span> highlight: <a href='/projects/lifehacks'>app with >750K installs</a>, <a href='/projects/video-stab'>real time image stabilization on Android</a><br/>" +
